/**
 * /me/leave/new — Submit a new leave request. Web port of apps/mobile/app/leave-new.tsx.
 *
 ...
 * the picker (no upload support yet, LR-2 deferred).
 */
...
export function AgentLeaveCreateScreen() {
